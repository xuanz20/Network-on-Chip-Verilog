...
#
# Generated by export_simulation on Wed Sep 07 17:20:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dataout_buf_IP9.sh' script.

./dataout_buf_IP9.sh -reset_run
...
./dataout_buf_IP9.sh -noclean_files

For more information on the script, please type './dataout_buf_IP9.sh -help'.
