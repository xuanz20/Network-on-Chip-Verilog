...
#
# Generated by export_simulation on Wed Sep 07 17:21:57 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dataout_buf_IP11.sh' script.

./dataout_buf_IP11.sh -reset_run
...
./dataout_buf_IP11.sh -noclean_files

For more information on the script, please type './dataout_buf_IP11.sh -help'.
