...
#
# Generated by export_simulation on Wed Sep 07 17:17:39 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dataout_buf_IP7.sh' script.

./dataout_buf_IP7.sh -reset_run
...
./dataout_buf_IP7.sh -noclean_files

For more information on the script, please type './dataout_buf_IP7.sh -help'.
