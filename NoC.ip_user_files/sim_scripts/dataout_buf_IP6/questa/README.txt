...
#
# Generated by export_simulation on Wed Sep 07 17:13:13 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dataout_buf_IP6.sh' script.

./dataout_buf_IP6.sh -reset_run
...
./dataout_buf_IP6.sh -noclean_files

For more information on the script, please type './dataout_buf_IP6.sh -help'.
